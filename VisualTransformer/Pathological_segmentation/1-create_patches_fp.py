...
Image.MAX_IMAGE_PIXELS = None  ##改动，为了解除限制


def stitching(file_path, wsi_object, downscale=16):
    start = time.time()
...
def compute_patch_level(wsi, level0_mag, target_mag=20, patch_size=256):
    ...
    return target_level, target_patch_size, target_patch_size
    ...
    for i in range(total):
        ...
        if stitch:
            ...
            if os.path.isfile(file_path):
                heatmap, stitch_time_elapsed = stitching(file_path, WSI_object, downscale=16)
...
if __name__ == '__main__':
    ...
    seg_times, patch_times = seg_and_patch(**directories, **parameters, patch_size=args['patch_size'],
                                           ...
                                           patch=args['patch'], process_list=process_list,
